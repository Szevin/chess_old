...
const BishopSvg = ({ color }: { color: ColorTypes }) => (
  <>
    {color === 'black' && (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
      ...
      >
        ...
        <path
          d="M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 25 16 A 2.5 2.5 0 1 1  20,16 A 2.5 2.5 0 1 1  25 16 z"
